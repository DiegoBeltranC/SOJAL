...
<?php
 ...
 $response = $client->request('GET', 'http://localhost/API_SOJAL/consult_users.php?opcion=1');
                    ...
                    <?php foreach ($data as $item): ?>
                        <tr>
                            ...
                            <td class="icon-cell">
                                ...
                                <a href="#" title="Eliminar" class="icon" onclick="return eliminar(<?= $item['id_usuario'] ?>);"><i class="fas fa-trash-alt"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
